...
const MovieCard = (props) => {
    ...
    const {posterPath, moviesTitle} = props;
  ...
  return (
    <div className='relative w-36 md:w-40 pr-2'>
      ...
      <button className='bg-white bg-opacity-60 text-black m-1 p-1 px-2 text-sm font-semibold  rounded-lg hover:bg-opacity-90'> ▷ Play</button>
      </div>
